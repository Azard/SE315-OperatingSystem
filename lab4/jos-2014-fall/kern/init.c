...
i386_init(void)
{
	...
	// For challenge
	/*
	ENV_CREATE(user_test_priority_super, ENV_TYPE_USER);
	ENV_CREATE(user_test_priority_high, ENV_TYPE_USER);
	ENV_CREATE(user_test_priority_middle, ENV_TYPE_USER);
	ENV_CREATE(user_test_priority_low, ENV_TYPE_USER);
	*/
